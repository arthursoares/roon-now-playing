...
async function installProviderFixture(page: Page, generationEnabled = true): Promise<{ requests: RecordedRequest[] }> {
...
test('active account capability exposes Codex and saves then tests it without authorization headers', async ({ page }, testInfo) => {
