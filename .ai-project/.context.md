...
import { LAYOUTS, FONTS, FONT_CONFIG, BACKGROUNDS, BACKGROUND_CONFIG } from '@roon-screen-cover/shared';
```
...
| Name generator | `packages/server/src/nameGenerator.ts` |
| Client names store | `packages/server/src/clientNames.ts` |
| Screen config view | `packages/client/src/views/ScreenConfigView.vue` |
...
- Screen config: http://localhost:3000/admin/screen/gentle-fox-17
